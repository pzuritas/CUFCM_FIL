...
cilia_nvidia4_CUFCM_double: $(CILIA_CPP) $(CILIA_CUDA)
	nvcc $^ -DUSE_DOUBLE_PRECISION $(NVCC_FLAGS) $(LINK) $(GEN_FLAGS) -o bin/cilia_1e-6_testing_build_a_beat

cilia_nvidia4_CUFCM: $(CILIA_CPP) $(CILIA_CUDA)
	nvcc $^ $(NVCC_FLAGS) $(LINK) $(GEN_FLAGS) -o bin/cilia_1e-6_testing_build_a_beat
